...
Кастомная интеграция для [Home Assistant](https://www.home-assistant.io) · версия **1.3.0**.
...
Custom [Home Assistant](https://www.home-assistant.io) integration · version **1.3.0**.
